...
### Self Check
- Do the odd numbered `p` elements share a class? yup
- Do the even numbered `div` elements have unique IDs? yup
- Does the Number 3 element have multiple classes? yup
